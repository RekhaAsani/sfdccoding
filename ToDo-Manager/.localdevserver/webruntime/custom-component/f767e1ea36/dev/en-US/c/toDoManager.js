Webruntime.define('lwc/toDoManager', ['lwc'], function (lwc) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".time" + shadowSelector + "{font-size: 4rem ;font-weight: 600;}\n.greeting" + shadowSelector + " {font-size: 2rem ;font-weight: 400;}\n.container" + shadowSelector + " {background-color: white;padding: 16px;max-height: 480px;overflow-y: scroll;display: block;}\n";
    }
