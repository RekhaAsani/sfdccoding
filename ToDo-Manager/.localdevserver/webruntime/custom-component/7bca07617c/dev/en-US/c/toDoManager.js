Webruntime.define('lwc/toDoManager', ['lwc', 'lightning/configProvider', 'c/toDoItem'], function (lwc, configProvider, _cToDoItem) { 'use strict';

    _cToDoItem = _cToDoItem && Object.prototype.hasOwnProperty.call(_cToDoItem, 'default') ? _cToDoItem['default'] : _cToDoItem;
    ...
    **/
    ...
    if (_implicitStylesheets$6) {
      tmpl$j.stylesheets.push.apply(tmpl$j.stylesheets, _implicitStylesheets$6);
    }
    ...
    * */
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-layout", _lightningLayout, {
        ...
        key: 0
      }, [api_dynamic($cmp.time), api_text(" ")])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
        },
        key: 3
        ...
        key: 2
      }, [api_dynamic($cmp.greeting)])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
        },
        key: 5
        ...
        classMap: {
          ...
          "slds-m-vertical_large": true
        },
        key: 4
      }, [api_text("What is your main focus for today?")])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        classMap: {
        ...
        key: 8,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.addTodoHandler))
        }
      }, [])])])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "size": "12"
        ...
        key: 12
      }, [api_text("UPCOMING")]), api_iterator($cmp.upcomingTasks, function (todo) {
        return api_custom_element("c-to-do-item", _cToDoItem, {
          props: {
            "todoId": $cmp.todoId,
            "todoName": $cmp.todoName
          },
          key: api_key(13, todo.todoId)
        }, []);
      }), api_element("div", {
        key: 14
      }, [api_text("COMPLETED")]), api_iterator($cmp.completedTasks, function (todo) {
        return api_element("div", {
          classMap: {
            "item-class": true
          },
          key: api_key(18, todo.todoId)
        }, [api_element("span", {
          classMap: {
            "slds-test-heading_label": true
          },
          key: 15
        }, [api_dynamic(todo.todoName)]), api_custom_element("lightning-button-icon", _lightningButtonIcon, {
          classMap: {
          ...
          key: 16,
          on: {
            "click": _m1 || ($ctx._m1 = api_bind($cmp.updateHandler))
          }
        }, []), api_custom_element("lightning-button-icon", _lightningButtonIcon, {
          props: {
          ...
          key: 17,
          on: {
            "click": _m2 || ($ctx._m2 = api_bind($cmp.deleteHandler))
          }
        }, [])]);
      })]))])];
    }
