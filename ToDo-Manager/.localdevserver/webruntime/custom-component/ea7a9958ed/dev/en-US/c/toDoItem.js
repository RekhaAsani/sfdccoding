Webruntime.define('lwc/toDoItem', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".todo" + shadowSelector + " {border: 1px solid lightgray;padding: .5rem;width: fit-content;border-radius: 8px;margin-top: 8px;margin-left: auto;margin-right: auto;transition: all .5s ease;}\n.completed" + shadowSelector + "{background-color: darkturquoise;}\n.completed-hover" + shadowSelector + " {background-color: lightcyan;border-radius: 16px;}\n.upcoming" + shadowSelector + "{background-color: lightcoral;}\n.upcoming-hover" + shadowSelector + "{background-color: lightpink;border-radius: 16px;}\n";
    }
    ...
    **/
    ...
    function tmpl$4($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 1,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.updateHandler))
        }
        ...
        key: 2,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.deleteHandler))
        }
      }, [])])];
    }
