Webruntime.define('lwc/toDoManager', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-layout", _lightningLayout, {
        ...
        return api_element("div", {
          ...
          key: 19,
          on: {
            "click": _m3 || ($ctx._m3 = api_bind($cmp.updateHandler))
          }
        }, []), api_custom_element("lightning-button-icon", _lightningButtonIcon, {
          props: {
            "iconName": "utility:delete",
          ...
          key: 20,
          on: {
            "click": _m4 || ($ctx._m4 = api_bind($cmp.deleteHandler))
          }
        }, [])]);
      })]))])];
    }
